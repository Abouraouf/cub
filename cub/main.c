...
/*   Updated: 2025/10/17 11:24:24 by ayel-arr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	setup_textures(t_info *minimap, t_cub3d *p)
{
	...
	minimap->textures[0].img_ptr = mlx_xpm_file_to_image(minimap->mlx, p->xpm_inorder[0],
		&minimap->textures[0].width, &minimap->textures[0].height);
	minimap->textures[0].addr = mlx_get_data_addr(minimap->textures[0].img_ptr,
		&minimap->textures[0].bits_per_pixel, &minimap->textures[0].line_length, &minimap->textures[0].endian);
	minimap->textures[1].img_ptr = mlx_xpm_file_to_image(minimap->mlx,
		p->xpm_inorder[1], &minimap->textures[1].width, &minimap->textures[1].height);
	minimap->textures[1].addr = mlx_get_data_addr(minimap->textures[1].img_ptr,
		&minimap->textures[1].bits_per_pixel, &minimap->textures[1].line_length, &minimap->textures[1].endian);
	minimap->textures[2].img_ptr = mlx_xpm_file_to_image(minimap->mlx, p->xpm_inorder[2],
		&minimap->textures[2].width, &minimap->textures[2].height);
	minimap->textures[2].addr = mlx_get_data_addr(minimap->textures[2].img_ptr,
		&minimap->textures[2].bits_per_pixel, &minimap->textures[2].line_length, &minimap->textures[2].endian);
	minimap->textures[3].img_ptr = mlx_xpm_file_to_image(minimap->mlx, p->xpm_inorder[3],
		&minimap->textures[3].width, &minimap->textures[3].height);
	minimap->textures[3].addr = mlx_get_data_addr(minimap->textures[3].img_ptr,
		&minimap->textures[3].bits_per_pixel, &minimap->textures[3].line_length, &minimap->textures[3].endian);
}
